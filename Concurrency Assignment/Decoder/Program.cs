...
namespace Decoder
{
    ...
    class WorkingParams
    {
        public const string studentNumberOne = "1008331"; // This must be filled.
        ...
        public const int numOfWorkers = 10; // how many workers are needed to keep the max size of the shared buffer between 50 - 100?
        public const int minSendIntervalTime = 150; // min sending interval time (in msec) by the provider
        public const int maxSendIntervalTime = 250; // max sending interval time (in msec) by the provider
    }
